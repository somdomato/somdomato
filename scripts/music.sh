...
ssh root@$MACHINE "chown -R liquidsoap:liquidsoap $SONGS_PATH && chown -R nginx:nginx $SONGS_PATH/uploads  && find $SONGS_PATH -type d -exec chmod 755 '{}' \; && find $SONGS_PATH -type f -exec chmod 644 '{}' \;"
