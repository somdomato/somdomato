  ...
  return (
    <div className="rounded-xl bg-background-alt border-2 border-primary/20 p-3 shadow-lg hover:shadow-2xl hover:border-primary/40 transition-all duration-300">
      <div className="mx-auto max-w-lg text-center">
        <h2 className="text-3xl/tight font-bold sm:text-4xl">A Rádio Som do Mato</h2>
      ...
      <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-3">
        <div className="rounded-xl overflow-hidden mb-3 bg-background/50 p-2">
          <Image className="rounded-lg w-full object-cover transform hover:scale-105 transition-transform duration-300" src="/images/features/feature-1.png" alt="High performance icon" width={300} height={300} />
        </div>
        ...
        <div className="rounded-xl overflow-hidden mb-3 bg-background/50 p-2">
          <Image className="rounded-lg w-full object-cover transform hover:scale-105 transition-transform duration-300" src="/images/features/feature-2.png" alt="Enterprise security icon" width={300} height={300} />
        </div>
        ...
        {/* <div className="group rounded-xl bg-background-alt border-2 border-primary/20 p-6 shadow-lg hover:shadow-2xl hover:border-primary/40 transition-all duration-300"> */}
        <div className="rounded-xl overflow-hidden mb-3 bg-background/50 p-2">
          <Image className="rounded-lg w-full object-cover transform hover:scale-105 transition-transform duration-300" src="/images/features/feature-3.png" alt="Highly configurable icon" width={300} height={300} />
        </div>
